...
export default class DisctrictInfos{
  ...
  changeInfos(district){
    ...
    this.listInfos[0].innerHTML = `${this.data.districts[district+1].revenus} €`
    this.listInfos[1].innerHTML = `${this.data.districts[district+1].population} %`
    this.listInfos[2].innerHTML = this.data.districts[district+1].politique
    this.listInfos[3].innerHTML = this.data.districts[district+1].professionnel
    this.listInfos[4].innerHTML = this.data.districts[district+1].proprete
    this.listInfos[5].innerHTML = `${this.data.districts[district+1].pollution} %`
    this.listInfos[6].innerHTML = `${this.data.districts[district+1].sonore} decibels`
    ...
    this.listInfos[11].innerHTML = `${this.data.districts[district+1].happiness} points`
  }
}